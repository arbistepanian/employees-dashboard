...
import { Employee, EmployeesResult } from "../lib/types/employees";
...
export default function EmployeesPage() {
    ...
    async function fetchEmployees(page: number) {
        ...
        try {
            ...
            const data: EmployeesResult = await response.json();
    ...
    return (
        <Page title="Employees">
            <div className="w-full flex justify-between items-center mt-4 mb-10">
                {isLoading ? (
                    <div className="flex justify-start items-center gap-2">
                        <Spinner />
                        <Paragraph>Loading employees...</Paragraph>
                    </div>
                ) : (
            ...
            {!error && employees.length === 0 && (
                <Paragraph>No employees found.</Paragraph>
            )}
